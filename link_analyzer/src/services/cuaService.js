...
/**
 * Запускает CUA-режим для URL.
 * @param {string} url
 * @param {object} options
 * @param {string} [options.contentType]
 * @param {object} [options.signals]
 * @returns {Promise<{ parsedPageFromCUA: ParsedPage | null, projectInfoFromCUA: import('../models/ProjectInfo') | null, projectInfoText: string | null, limitations: string[], errors: string[] }>}
 */
